            ...
            <div class="py-2 relative">
              ...
              <div class="flex content-start items-start">
                ...
                <div class="px-1 flex-1">
                  ...
                  <%= text_input fc, :content, class: "text-field", placeholder: "(555) 555-5555", phx_debounce: 2000 %>
              ...
              <%= if fc.data.type === "phone" || (Map.has_key?(fc.source.changes, :type) && fc.source.changes.type === "phone") do %>
                <div class="w-full px-1 pt-3">
                  ...
                  <%= label fc, :textable, "Recieve text messages using this number?", class: "text-sm cursor-pointer inline pl-2" %>
                </div>
              <% end %>
            </div>
          <% end %>
