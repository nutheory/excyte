defmodule ExcyteWeb.Helpers.UI do
  ...
  def toggle_menu(js \\ %JS{}, id) do
    ...
    |> JS.toggle(
      to: "##{id}_menu",
      in:
        {"transition ease-out duration-200", "transform opacity-0 scale-90",
         "transform opacity-100 scale-100"},
      out:
        {"transition ease-in duration-75", "transform opacity-100 scale-100",
         "transform opacity-0 scale-90"}
    )
  ...
  def modal(assigns) do
    ...
    <div id="modal" class="blackout" phx-remove={hide_modal()} phx-click={hide_modal()}>
      <div id="modal-content" class="ex-modal" phx-window-keydown={hide_modal()} phx-key="escape">
          ...
          <%= live_redirect to: Routes.live_path(@socket, ExcyteWeb.Agent.Dashboard) do %>
            ...
            >
              <defs>
                ...
                <circle id="path-12" cx="303.5" cy="94.5" r="15.5"></circle>
                <filter
                  x="-3.2%"
                  y="-3.2%"
                  width="112.9%"
              ...
              <g id="Page-11" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="Desktop-HD-1" transform="translate(-27.000000, -20.000000)">
                  <g id="Group-1" transform="translate(27.000000, 20.000000)">
                    <g id="Oval-1">
                    ...
                    <g id="Group-12" transform="translate(0.000000, 13.000000)" fill-rule="nonzero">
                      <path
  ...
  def dropdown(assigns) do
    ...
    >
      ...
      >
        <div class="flex px-2">
          <div class="ml-2">
            <%= if @selected !== nil, do: extract_text(@selected), else: @label %>
          </div>
