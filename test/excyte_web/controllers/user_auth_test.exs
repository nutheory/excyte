defmodule ExcyteWeb.UserAuthTest do
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ExcyteWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})

    %{user: agent_fixture(), conn: conn}
  end
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      ExcyteWeb.Endpoint.subscribe(live_socket_id)
