defmodule ExcyteWeb.UserSessionControllerTest do
  ...
  describe "GET /users/log_in" do
    test "renders log in page", %{conn: conn} do
      ...
      # assert response =~ "login with email</a></a>"
      assert response =~ "free trial</a>"
    end
  ...
  describe "POST /users/log_in" do
    test "logs the user in", %{conn: conn, user: user} do
      ...
      assert {:error, {:redirect, %{to: "/agent/getting-started"}}}
    end
